...
.feedbacksubmit input[type="submit"]:hover {
...
<body>
    <div class="container">
        ...
        <div class="bar">
            <div class="logo">
                <img src="logo.jpg" alt="Crimson Bakery Logo">
            </div>
    ...
    <div class="main-content">
        ...
        <div class="image-slider">
            ...
            <div class="slide-image fade"><img src="choc cake.png"  alt="Chocolate Cake"></div>
            <div class="slide-image fade"><img src="orangecalke.png"  alt="Orange Cake"></div>
            <div class="slide-image fade"><img src="rice.png"  alt="Rice Pudding"></div>
            <div class="slide-image fade"><img src="pizza.png"  alt="Pizza"></div>
            <div class="slide-image fade"><img src="stawberrycake.png"  alt="Strawberry Cake"></div>
            <div class="slide-image fade"><img src="buns.png"  alt="Buns"></div>
        ...
        <div class="categories">
            <a href="#items"><div class="category"><img src="type (1).png"  alt="Pastries"><h3>Pastries</h3></div></a>
            <a href="#items"><div class="category"><img src="type (2).png"  alt="Cakes"><h3>Cakes</h3></div></a>
            <a href="#items"><div class="category"><img src="type (3).png"  alt="Coffee"><h3>Coffee</h3></div></a>
            <a href="#items"><div class="category"><img src="type (4).png"  alt="Bread"><h3>Bread</h3></div></a>
            <a href="#items"><div class="category"><img src="type (5).png"  alt="Others"><h3>Others</h3></div></a>
        </div>

        <!-- Long image 1 -->
        <div class="long-image1"> 
            <img src="long cake.jpg" alt="Promotional Banner 1"> 
        </div>
        ...
        while($row=mysqli_fetch_array($result)){
            ...
            echo "<div class=\"item\"><img src=\"".$row['image_path']."\"  alt=\"".$row['item_name']."\"><h3>".$row['item_name']."</h3><p class=\"price\">Rs ".$row['price']."</p><span class=\"cart-icon\"><i class=\"fa-solid fa-cart-plus\" id=\"".$row['id']."\"></i></span></div>";
        ...
        <div class="long-image2"> 
            <img src="Cakeslong.jpg"  alt="Promotional Banner 2"> 
        </div>

        <!-- About Us -->
        <section id="about" class="about">
            <img src="pexels-zvolskiy-2253643.jpg"  alt="About Us">
        ...
        <section id="feedback" class="feedback">
            ...
            <form action="#" method="POST">
               <div class="feedbackinput">
                ...
                <input type="text" id="name" name="name" required placeholder="Enter your name" max-length = "40">
               </div>
               <div class="feedbackinput">
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" required placeholder="Enter your email address" max-lenth = "50">
                </div>
                <div class="feedbackinput">
                <label for="subject">Subject:</label>
                <input type="text" id="subject" name="subject" required placeholder="e.g., Cake Quality, Service, Website Issue" max-length = "30">
                </div>
                <div class="feedbackinput">
                <label for="message">Feedback / Message:</label>
                <textarea id="message" name="message" required placeholder="Tell us about your experience!" max-length = "150"></textarea>
                </div>
                <div class="feedbacksubmit">
                <input type="submit" value="Submit Feedback"></div>
            </form>
        </section>
    ...
    <footer>
        ...
        <div class ="stafflogin"><a href="stafflogin.html"><i class ="fa-solid fa-user"> Staff Login</i></a></div>
    </footer>
